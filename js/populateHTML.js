...
function populateSkills(items, id) {
	...
	for (let i = 0; i < items.length; i++) {
		...
		divAnimateBox.className = "col-md-6 animate-box1";
...
function populateExp_Edu(items, id) {
	...
	for (let i = 0; i < items.length; i++) {
		...
		article.className = "timeline-entry animate-box1";
	...
	let article = document.createElement("article");
	article.className = "timeline-entry begin animate-box1";
	article.append(divTimelineEntryInner);
...
populateSkills(data.skills2, "skills2");
populateSkills(data.skills3, "skills3");
populateSkills(data.skills4, "skills4");
populateSkills(data.skills5, "skills5");
